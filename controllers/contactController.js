...
exports.contactUs = async (req, res) => {
  try {
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <p style="font-size: 14px; color: #999999;">
              This is an automated notification from the Sindhrozgar contact form.
            </p>
          </td>
        </tr>
      </table>
      ...
      <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 1px solid #ddd; margin-top: 20px;">
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #555555;">
              Thank you for reaching out to Sindhrozgar. We have successfully received your message and our team will get back to you as soon as possible.
            </p>
    ...
    const userEmailResult = await sendEmail({
      email: email,
      subject: "Thank You for Contacting Sindhrozgar",
      html: userEmailHtml,
      emailType: "contact",
    });
