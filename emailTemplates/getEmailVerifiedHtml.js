      ...
      <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 1px solid #ddd; margin-top: 20px;">
        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <h3 style="color: #333333;">Welcome to Sindhrozgar</h3>
            ...
            <p style="font-size: 16px; color: #555555;">
              Congratulations! Your email has been successfully verified. Your account is now active and you can access all features of Sindhrozgar.
            </p>
            ...
            <p style="font-size: 16px; color: #555555;">
              Welcome to the Sindhrozgar family!<br />
