        ...
        <tr>
          <td style="padding: 30px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://hunarmandpunjab.org.pk/admission-result" style="background-color: #079560; color: #ffffff; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 5px; margin: 10px; display: inline-block;">
                View Payment Status
              </a>
              <br>
            ...
            <div style="background-color: #e9f7ef; border: 1px solid #b2f0c0; padding: 15px; border-radius: 8px; margin: 20px 0;">
              ...
              <p style="font-size: 14px; color: #155724; margin: 0;">
                If you have any questions about the payment process or need assistance, please contact our support team at <a href="mailto:contact@hunarmandpunjab.com" style="color: #079560;">contact@hunarmandpunjab.com</a>
              </p>
            </div>
            ...
            <p style="font-size: 16px; color: #555555;">
              Thank you for choosing Sindhrozgar!<br />
