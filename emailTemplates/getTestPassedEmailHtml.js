      ...
      <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 1px solid #ddd; margin-top: 20px;">
        <tr>
          <td style="text-align: center;">
            <img src="https://hunarmandpunjab.org.pk/images/email_banner.png" alt="Sindhrozgar" style="width: 100%; max-width: 600px;" />
          </td>
        </tr>
        <tr>
          <td style="padding: 30px;">
            <h2 style="color: #28a745;">🎉 Congratulations! You Have Passed the Admission Test</h2>
            <h3 style="color: #333333;">Now You Are Eligible For Sindhrozgar Scholarship Card</h3>
            ...
            <p style="font-size: 16px; color: #555555;">
              We are thrilled to inform you that you have successfully cleared the Sindhrozgar Admission Test. Now you are eligible for a Scholarship Card. To confirm your seat & proceed with your enrolled course. All the courses under the Hunarmand scholarship card are 100% free, but the application processing fee is necessary to complete your application. Your processing fee will be reimbursed if you achieve above 85% Marks in the final evaluation test under the policy of Sindhrozgar.
            </p>
