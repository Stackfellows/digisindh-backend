...
module.exports = {
  ...
  emails: {
    ...
    verification: {
      email: process.env.VERIFICATION_EMAIL || 'noreply@sindhrozgar.com',
      name: 'Sindhrozgar - No Reply'
    },
    
    // Admission Test Email Notification & Challan Email Notification & Certificate Notification
    admissions: {
      email: process.env.ADMISSIONS_EMAIL || 'admissions@sindhrozgar.com',
      name: 'Sindhrozgar - Admissions'
    },
    
    // Password Reset & Scholarship Card & Contact
    contact: {
      email: process.env.CONTACT_EMAIL || 'contact@sindhrozgar.com',
      name: 'Sindhrozgar - Contact'
    }
  }
}; 